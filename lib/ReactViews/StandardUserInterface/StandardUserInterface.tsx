...
// 自定义的组件
import { DataBuilder } from "terriajs/lib/CAUViews/DisplayPanel/DataBuilder";
...
const StandardUserInterfaceBase: React.FC<StandardUserInterfaceProps> =
  observer((props) => {
    ...
    // 自定义变量
    const showDataBuilder =
      props.viewState.dataBuilderShown &&
      !props.viewState.useSmallScreenInterface;
