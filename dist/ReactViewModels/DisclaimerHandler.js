...
export default class DisclaimerHandler {
    ...
    _openConfirmationModal(catalogItem, callback) {
        this.viewState.terria.notificationState.addNotificationToQueue(combine({
            confirmAction: callback
        }, DisclaimerHandler._generateOptions(catalogItem)));
    }
    _openNotificationModel(catalogItem) {
        this.viewState.terria.notificationState.addNotificationToQueue(DisclaimerHandler._generateOptions(catalogItem));
    }
    /**
...
//# sourceMappingURL=DisclaimerHandler.js.map