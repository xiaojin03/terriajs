 ...
 */
export function generateCesiumInfoHTMLFromProperties(properties, time, showStringIfPropertyValueIsNull) {
    let html = "";
    if (typeof (properties === null || properties === void 0 ? void 0 : properties.getValue) === "function") {
            ...
            if (Object.prototype.hasOwnProperty.call(properties, key)) {
                ...
                if (isDefined(value)) {
                    ...
                    if (Array.isArray(properties)) {
                        html +=
                            "<tr><td>" +
                                generateCesiumInfoHTMLFromProperties(value, time, showStringIfPropertyValueIsNull) +
                                "</td></tr>";
                    }
...
//# sourceMappingURL=generateCesiumInfoHTMLFromProperties.js.map